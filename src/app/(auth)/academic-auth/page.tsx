          ...
          {tab === 'login' && (
            <form onSubmit={handleLogin}>
              ...
              <button type="button" onClick={handleGoogleLogin}
                className="w-full flex items-center justify-center gap-3 py-3 border border-[#e5e7eb] rounded-xl bg-white hover:bg-gray-50 transition-colors text-[0.9rem] font-medium text-[#374151] mb-4">
