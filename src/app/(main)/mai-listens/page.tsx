      ...
      <div className="min-h-screen bg-[#f7f8f3] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl p-12 text-center max-w-md w-full shadow-sm border border-[#dfe5da]">
          ...
          <p className="text-[#667065] text-sm leading-relaxed mb-6">
            Thank you for sharing your community's needs with MAI. Your feedback will help shape the development agenda for Edo South.
          </p>
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-[#01381d] to-[#015b2d] text-white py-20 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="font-heading text-[clamp(3rem,8vw,5.2rem)] leading-[0.95]">
            COMMUNITY <span className="text-[#f97316]">FEEDBACK FORM</span>
          </h1>
          <p className="max-w-3xl mx-auto mt-4 opacity-90 text-base leading-[1.75]">
            Tell MAI what your community needs. Your feedback helps Hon. Mathew Aigbuhenze Iduoriyekemwen identify key areas to advocate for Edo South development.
          </p>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelClass}>Age Range <span className="text-[#f97316]">*</span></label>
                      <select name="age_range" value={form.age_range} onChange={handleChange} required className={inputClass}>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div><label className={labelClass}>What is the issue affecting your community? <span className="text-[#f97316]">*</span></label><textarea name="issue" value={form.issue} onChange={handleChange} required rows={4} placeholder="What is the issue affecting your community?" className={`${inputClass} resize-y`} /></div>
                    <div><label className={labelClass}>How long has this issue existed?</label><textarea name="duration" value={form.duration} onChange={handleChange} rows={3} placeholder="How long has this issue existed?" className={`${inputClass} resize-y`} /></div>
                    <div className="md:w-1/2">
                      <label className={labelClass}>How many people are affected? <span className="text-[#f97316]">*</span></label>
                      <select name="affected" value={form.affected} onChange={handleChange} required className={inputClass}>
                        <option value="">Select one</option>
                        <option>Few persons</option><option>One street</option><option>One community</option><option>Multiple communities</option><option>Entire ward</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                {/* 5. Evidence Upload */}
                <div>
                  <SectionHead num={5} title="Evidence Upload" note="Upload photo or video showing the issue, if available." />
                  <input type="file" accept="image/*,video/*" onChange={e => setFile(e.target.files?.[0] || null)} className={inputClass} />
                  <p className="text-[0.82rem] text-[#667065] mt-2">Upload photo or video showing the issue (optional)</p>
                </div>
                ...
                <div>
                  ...
                  <div className="md:w-1/2">
                    ...
                    <select name="priority" value={form.priority} onChange={handleChange} className={inputClass}>
                      <option>Very urgent</option><option>Urgent</option><option>Important but not urgent</option>
                    </select>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div><label className={labelClass}>What do you think should be done?</label><textarea name="solution" value={form.solution} onChange={handleChange} rows={4} placeholder="What do you think should be done?" className={`${inputClass} resize-y`} /></div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-[#eef3ea] border-[1.5px] border-[#015b2d]/[0.12] rounded-[18px] p-5">
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <span className="text-sm text-[#667065] leading-relaxed">
                        I agree that this information may be used for community development, advocacy, and planning.
                      </span>
                    </label>
                  </div>
                </div>
