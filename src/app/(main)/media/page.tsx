...
const STATIC_MEDIA_ITEMS = [
  { id: 'static-1', type: 'image', category: 'campaign', image_url: '/img-1.jpeg', title: 'MAI Campaign Portrait', caption: 'Hon. Matthew Aigbuhuenze Iduoriyekemwen' },
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {FILTERS.map(f => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-semibold border-2 transition-colors ${activeFilter === f.value
