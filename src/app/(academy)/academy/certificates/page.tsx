...
const SCHOOL_META = [
  ...
  { slug: 'school-of-technology-and-digital-services', icon: 'ti ti-devices', iconBg: '#e0e7ff', iconColor: '#3730a3', title: 'School of Technology & Digital Skills', cert: 'MAI Professional Certificate in Technology & Digital Services' },
    ...
    async function fetchData() {
      ...
      const result: SchoolCert[] = SCHOOL_META.map(meta => {
        ...
        return {
          ...
          // Show 'earned' if certificate exists in DB OR all courses passed
          status: (earned || allPassed) ? 'earned' : enrolledCount > 0 ? 'progress' : 'locked',
  ...
  return (
    <div>
      <p className="text-[13px] text-[#6B7280] font-light mb-5">
        Earn a certificate for each school by completing all courses within it.
      </p>
