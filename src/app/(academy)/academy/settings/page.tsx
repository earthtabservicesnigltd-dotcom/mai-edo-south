    ...
    <div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-xl p-5 mb-5">
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            <label key={p.key} className="flex items-center gap-2.5 text-[13px] text-[#111827] cursor-pointer hover:text-[#f97316] transition-colors">
      ...
      <div className="flex gap-2.5 justify-end">
        <button onClick={() => router.push('/academy')}
          className="text-[12px] font-medium px-4 py-2.5 rounded-lg border border-[#E5E7EB] bg-white text-[#111827] cursor-pointer hover:bg-[#F7F4EE] hover:border-[#6B7280] transition-all">
          Cancel
        </button>
        <button
          className="inline-flex items-center gap-1.5 bg-[#f97316] text-white text-[12px] font-semibold px-5 py-2.5 rounded-lg border-none cursor-pointer hover:bg-[#ea6a05] hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(249,115,22,0.3)] transition-all">
