...
export default function CertificateCard({ cert, showDownload = true }: CertificateCardProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="w-full overflow-x-auto overflow-y-hidden rounded-xl border border-[#E5E7EB] shadow-sm">
        <div className="min-w-[900px] w-[900px] mx-auto">
          <div
            ref={certRef}
            className="relative w-full aspect-[1.414/1] bg-white border-[3px] border-[#01381d] overflow-hidden font-sans"
          >
            {/* Corner accents */}
